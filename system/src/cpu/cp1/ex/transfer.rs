...
pub fn mfc1(cpu: &mut Cpu, pc: u32, word: u32) -> DcOperation {
...
pub fn dmfc1(cpu: &mut Cpu, pc: u32, word: u32) -> DcOperation {
    let rt = ((word >> 16) & 31) as usize;
    let rd = ((word >> 11) & 31) as usize;
...
pub fn mtc1(cpu: &mut Cpu, pc: u32, word: u32) -> DcOperation {
    let rt = ((word >> 16) & 31) as usize;
    let rd = ((word >> 11) & 31) as usize;
...
pub fn dmtc1(cpu: &mut Cpu, pc: u32, word: u32) -> DcOperation {
    let rt = ((word >> 16) & 31) as usize;
    let rd = ((word >> 11) & 31) as usize;
...
pub fn cfc1(cpu: &mut Cpu, pc: u32, word: u32) -> DcOperation {
    let rt = ((word >> 16) & 31) as usize;
    let rd = ((word >> 11) & 31) as usize;
...
pub fn ctc1(cpu: &mut Cpu, pc: u32, word: u32) -> DcOperation {
    let rt = ((word >> 16) & 31) as usize;
    let rd = ((word >> 11) & 31) as usize;
