...
pub fn add<F: Float>(cpu: &mut Cpu, pc: u32, word: u32) -> DcState {
...
pub fn sub<F: Float>(cpu: &mut Cpu, pc: u32, word: u32) -> DcState {
    let ft = ((word >> 16) & 31) as usize;
    let fs = ((word >> 11) & 31) as usize;
    let fd = ((word >> 6) & 31) as usize;
...
pub fn mul<F: Float>(cpu: &mut Cpu, pc: u32, word: u32) -> DcState {
    let ft = ((word >> 16) & 31) as usize;
    let fs = ((word >> 11) & 31) as usize;
    let fd = ((word >> 6) & 31) as usize;
...
pub fn div<F: Float>(cpu: &mut Cpu, pc: u32, word: u32) -> DcState {
    let ft = ((word >> 16) & 31) as usize;
    let fs = ((word >> 11) & 31) as usize;
    let fd = ((word >> 6) & 31) as usize;
