...
pub fn round_w<F: Float>(cpu: &mut Cpu, pc: u32, word: u32) -> DcState {
    let fs = ((word >> 11) & 31) as usize;
    let fd = ((word >> 6) & 31) as usize;
...
pub fn round_l<F: Float>(cpu: &mut Cpu, pc: u32, word: u32) -> DcState {
    let fs = ((word >> 11) & 31) as usize;
    let fd = ((word >> 6) & 31) as usize;
...
pub fn trunc_w<F: Float>(cpu: &mut Cpu, pc: u32, word: u32) -> DcState {
    let fs = ((word >> 11) & 31) as usize;
    let fd = ((word >> 6) & 31) as usize;
...
pub fn trunc_l<F: Float>(cpu: &mut Cpu, pc: u32, word: u32) -> DcState {
    let fs = ((word >> 11) & 31) as usize;
    let fd = ((word >> 6) & 31) as usize;
...
pub fn ceil_w<F: Float>(cpu: &mut Cpu, pc: u32, word: u32) -> DcState {
    let fs = ((word >> 11) & 31) as usize;
    let fd = ((word >> 6) & 31) as usize;
...
pub fn ceil_l<F: Float>(cpu: &mut Cpu, pc: u32, word: u32) -> DcState {
    let fs = ((word >> 11) & 31) as usize;
    let fd = ((word >> 6) & 31) as usize;
...
pub fn floor_w<F: Float>(cpu: &mut Cpu, pc: u32, word: u32) -> DcState {
    let fs = ((word >> 11) & 31) as usize;
    let fd = ((word >> 6) & 31) as usize;
...
pub fn floor_l<F: Float>(cpu: &mut Cpu, pc: u32, word: u32) -> DcState {
    let fs = ((word >> 11) & 31) as usize;
    let fd = ((word >> 6) & 31) as usize;
