...
pub fn i_type_checked<Op: ArithmeticOperator>(cpu: &mut Core, pc: u32, word: u32) -> DcState {
...
pub fn i_type_unchecked<Op: ArithmeticOperator>(cpu: &mut Core, pc: u32, word: u32) -> DcState {
    let rs = ((word >> 21) & 31) as usize;
    let rt = ((word >> 16) & 31) as usize;
    let imm = (word & 0xffff) as i16 as i32;
...
pub fn r_type_checked<Op: ArithmeticOperator>(cpu: &mut Core, pc: u32, word: u32) -> DcState {
    let rs = ((word >> 21) & 31) as usize;
    let rt = ((word >> 16) & 31) as usize;
...
pub fn r_type_unchecked<Op: ArithmeticOperator>(cpu: &mut Core, pc: u32, word: u32) -> DcState {
    let rs = ((word >> 21) & 31) as usize;
    let rt = ((word >> 16) & 31) as usize;
    let rd = ((word >> 11) & 31) as usize;
