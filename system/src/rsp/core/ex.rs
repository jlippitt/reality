...
pub fn execute(cpu: &mut Core, pc: u32, word: u32) -> DfOperation {
    match word >> 26 {
        ...
        0o10 => arithmetic::i_type::<arithmetic::Add, false>(cpu, pc, word),
        0o11 => arithmetic::i_type::<arithmetic::Add, true>(cpu, pc, word),
...
pub fn special(cpu: &mut Core, pc: u32, word: u32) -> DfOperation {
    match word & 63 {
        ...
        0o40 => arithmetic::r_type::<arithmetic::Add, false>(cpu, pc, word),
        0o41 => arithmetic::r_type::<arithmetic::Add, true>(cpu, pc, word),
        0o42 => arithmetic::r_type::<arithmetic::Sub, false>(cpu, pc, word),
        0o43 => arithmetic::r_type::<arithmetic::Sub, true>(cpu, pc, word),
